...
React와 Flutter를 중심으로 웹과 모바일 프로젝트를 개발하고 있습니다.  
직접 기능을 구현하고 화면을 만들어 보면서 배우는 과정을 즐깁니다.
...
- 🎓 부천대학교 컴퓨터소프트웨어과 졸업
- 📱 React,Flutter,Spring를 활용한 웹·모바일 프로젝트를 진행했습니다.
- 🎨 사용자 입장에서 보기 편한 화면을 만드는 것을 좋아합니다.
- 🤝 Git을 활용한 협업을 경험했습니다.
- 🌱 프로젝트를 만들면서 새로운 기술을 배우고 적용하는 편입니다.
